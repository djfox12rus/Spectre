...
QMenuBar * SignalLibrary::initMenuBar()
{
	...
	auto chooseAct = menuBar->addAction(QStringLiteral("¬ыбрать сигнал..."));
...
QList<QAction*> SignalLibrary::initActions()
{
	...
	acts.push_back(new QAction(QIcon(":/Spectre/Resources/verification-mark.png"), QStringLiteral("ѕрин€ть"), this));
	...
	acts.push_back(new QAction(QIcon(":/Spectre/Resources/exit.png"), QStringLiteral("«акрыть"), this));
...
QMenuBar * SignalLibrary::initMenuBar(const QList<QAction*>& acts)
{
	...
	auto menu = menuBar->addMenu(QStringLiteral("—игнал"));
